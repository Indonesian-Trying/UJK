                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('categories.destroy', $cate->id) }}" method="POST">
                                    <a class="btn btn-info" href="{{ route('categories.show', $cate->id) }}">
                                    ...
                                    <a class="btn btn-primary" href="{{ route('categories.edit', $cate->id) }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    ...
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" onclick="return confirm('Are you sure to delete {{ $cate->name }}?')"
