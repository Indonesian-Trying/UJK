    ...
    <div class="card card-xxl-stretch">
        ...
        <div class="card-body pt-5">
            <div class="row mb-10">
                <div class="col-lg-8">
                    @if ($book->img)
                        <img src="{{ asset('storage/images/' . $book->img) }}" alt="{{ $book->title }}'s cover"width="50%"
                            height="100%"">
                    @else
                        <p>No Picture</p>
                    @endif
            ...
            <div class="row mb-10">
                <label class="col-lg-4 fw-bold text-muted">
                    <div class="col-lg-8">
                        @if ($book->pdf)
                            <a class="btn-primary btn" href="{{ route('books.read', $book->id) }}" method="POST" target="_BLANK">Read
                                Book</a>
                        @else
                            <p>No PDF</p>
                        @endif
            ...
            <div class="row mb-10">
                <label class="col-lg-4 fw-bold text-muted">Synopsis</label>
                <div class="col-lg-8">
                    <span class="fw-bold fs-6 text-gray-800">{{ $book->synop }}</span>
                </div>
            </div>
            <div class="row mb-10">
